...
public class ProductDiscountCalculatorServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        writer.println("<h1>Product Description: " + product_description + "</h1><br>");
        writer.println("<h2>List Price: " + list_price  + "</h2>");
        writer.println("<h2>Discount Percent: " + discount_percent + "</h2>");
        writer.println("<h2>Discount Amount: " + discount_amount + "</h2>");
        writer.println("<h1>Discount Price: " + discount_price + "</h1><br>");
        writer.println("</html>");
    }
